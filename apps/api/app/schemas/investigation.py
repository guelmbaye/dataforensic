...
class LearningOut(BaseModel):
    """What the agent knew before it started, and what that cost or saved."""

    memory_assisted: bool = False
    matched_pattern: str | None = None
    reused_from_investigation_id: str | None = None
...
class InvestigationOut(BaseModel):
    ...
    learning: LearningOut = Field(default_factory=LearningOut)
    error: str | None = None
