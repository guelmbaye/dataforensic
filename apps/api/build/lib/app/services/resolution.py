...
from app.models.tables import Action, Evidence, Incident, Investigation, Verification
...
class ResolutionService:
    ...
    async def write_memory(
        ...
        return await self.memory.write_back(incident, investigation, document)
